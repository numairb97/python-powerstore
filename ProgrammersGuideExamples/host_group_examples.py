...
HG_DETAILS = CONN.provisioning.get_host_group_details(host_group_id=RESP["id"])
print(HG_DETAILS)

# Get Host Group by name
HG_BY_NAME = CONN.provisioning.get_host_group_by_name(host_group_name="pr-sdk-hg")
print(HG_BY_NAME)
